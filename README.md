...
If you wanted to make SAS website we have provided the code in the files so you can edit those code and make you own website.

NOTE: The files are given are just a example you must edit the code or the website will remain the same.
